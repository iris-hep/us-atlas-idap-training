...
# .claude/settings.local.json — see README.md. The only per-launch step left
# is (re)registering the Jupyter MCP server, whose URL changes on every
# Binder relaunch. Windows users: skip this script and register manually:
